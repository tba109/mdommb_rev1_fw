...
set cached_ip [config_ip_cache -export -no_bom  -dir C:/Users/atfie/IceCube/mDOMDevelopment/mdommb_rev1_fw/mDOM_mb_rev1.runs/AFE_PULSER_OUTPUT_synth_1 -new_name AFE_PULSER_OUTPUT -ip [get_ips AFE_PULSER_OUTPUT]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top AFE_PULSER_OUTPUT -part xc7s100fgga676-2 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix AFE_PULSER_OUTPUT_ AFE_PULSER_OUTPUT.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ AFE_PULSER_OUTPUT_stub.v
 lappend ipCachedFiles AFE_PULSER_OUTPUT_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ AFE_PULSER_OUTPUT_stub.vhdl
 lappend ipCachedFiles AFE_PULSER_OUTPUT_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ AFE_PULSER_OUTPUT_sim_netlist.v
 lappend ipCachedFiles AFE_PULSER_OUTPUT_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ AFE_PULSER_OUTPUT_sim_netlist.vhdl
 lappend ipCachedFiles AFE_PULSER_OUTPUT_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp AFE_PULSER_OUTPUT.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips AFE_PULSER_OUTPUT]
}

rename_ref -prefix_all AFE_PULSER_OUTPUT_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef AFE_PULSER_OUTPUT.dcp
