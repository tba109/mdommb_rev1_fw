...
HD_PWD='C:/Users/atfie/IceCube/mDOMDevelopment/mdommb_rev1_fw/mDOM_mb_rev1.runs/AFE_PULSER_OUTPUT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AFE_PULSER_OUTPUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AFE_PULSER_OUTPUT.tcl
