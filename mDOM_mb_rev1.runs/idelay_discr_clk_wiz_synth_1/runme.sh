...
HD_PWD='C:/Users/atfie/IceCube/mDOMDevelopment/mdommb_rev1_fw/mDOM_mb_rev1.runs/idelay_discr_clk_wiz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log idelay_discr_clk_wiz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source idelay_discr_clk_wiz.tcl
