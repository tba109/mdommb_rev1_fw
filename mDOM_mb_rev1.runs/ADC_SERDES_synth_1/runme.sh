...
HD_PWD='C:/Users/atfie/IceCube/mDOMDevelopment/mdommb_rev1_fw/mDOM_mb_rev1.runs/ADC_SERDES_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_SERDES.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_SERDES.tcl
