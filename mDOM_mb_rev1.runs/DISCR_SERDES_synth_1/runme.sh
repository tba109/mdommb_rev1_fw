...
HD_PWD='C:/Users/atfie/IceCube/mDOMDevelopment/mdommb_rev1_fw/mDOM_mb_rev1.runs/DISCR_SERDES_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DISCR_SERDES.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DISCR_SERDES.tcl
