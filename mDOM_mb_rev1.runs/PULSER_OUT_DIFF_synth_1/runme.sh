...
HD_PWD='C:/Users/atfie/IceCube/mDOMDevelopment/mdommb_rev1_fw/mDOM_mb_rev1.runs/PULSER_OUT_DIFF_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PULSER_OUT_DIFF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PULSER_OUT_DIFF.tcl
