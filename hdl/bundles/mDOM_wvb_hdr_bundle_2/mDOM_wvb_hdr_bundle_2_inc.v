...
localparam
  ...
  L_WIDTH_MDOM_WVB_HDR_BUNDLE_2_BSUM            = 19,
  L_WIDTH_MDOM_WVB_HDR_BUNDLE_2_BSUM_LEN_SEL    = 3,
  L_WIDTH_MDOM_WVB_HDR_BUNDLE_2_BSUM_VALID      = 1;
...
localparam 
  ...
  L_START_POS_MDOM_WVB_HDR_BUNDLE_2_BSUM            = 80,
  L_START_POS_MDOM_WVB_HDR_BUNDLE_2_BSUM_LEN_SEL    = 99,
  L_START_POS_MDOM_WVB_HDR_BUNDLE_2_BSUM_VALID      = 102;
...
localparam 
  ...
  L_STOP_POS_MDOM_WVB_HDR_BUNDLE_2_BSUM            = 98,
  L_STOP_POS_MDOM_WVB_HDR_BUNDLE_2_BSUM_LEN_SEL    = 101,
  L_STOP_POS_MDOM_WVB_HDR_BUNDLE_2_BSUM_VALID      = 102;

// Zero pad width and bundle width
localparam L_WIDTH_MDOM_WVB_HDR_BUNDLE_2_ZERO_PAD = 0;
localparam L_WIDTH_MDOM_WVB_HDR_BUNDLE_2 = 103;
