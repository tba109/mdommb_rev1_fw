...
#
# Generated by export_simulation on Tue Jan 26 11:48:33 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './ddr3_idelay_clk_wiz.sh' script.

./ddr3_idelay_clk_wiz.sh -reset_run
...
./ddr3_idelay_clk_wiz.sh -noclean_files

For more information on the script, please type './ddr3_idelay_clk_wiz.sh -help'.
